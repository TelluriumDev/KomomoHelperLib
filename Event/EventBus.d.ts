...
declare namespace EventBus {
    ...
    function emplaceListener(event: 'SpawnedMobEvent', callback: (mob: Mob, blockSource: BlockSource, identifier: ActorDefinitionIdentifier, actor: Actor, vec3: Vec3, naturalSpawn: boolean, surface: boolean, fromSpawner: boolean) => boolean, priority?: EventEnum.EventPriority): Listener
